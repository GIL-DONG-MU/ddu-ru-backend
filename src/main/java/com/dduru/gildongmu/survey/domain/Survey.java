...
public class Survey extends BaseTimeEntity {
    ...
    public void update(Survey survey) {
        this.q1Transport = survey.q1Transport;
        this.q2Waiting = survey.q2Waiting;
        this.q3Stay = survey.q3Stay;
        this.q4Wakeup = survey.q4Wakeup;
        this.q5Expense = survey.q5Expense;
        this.q6Spend = survey.q6Spend;
        if (this.q7Interests == null) {
            this.q7Interests = survey.q7Interests != null ? new ArrayList<>(survey.q7Interests) : null;
        } else {
            this.q7Interests.clear();
            if (survey.q7Interests != null) {
                this.q7Interests.addAll(survey.q7Interests);
            }
        }
        this.q8Planning = survey.q8Planning;
        this.q9Menu = survey.q9Menu;
        this.q10Companion = survey.q10Companion;
        this.q11Photo = survey.q11Photo;
    }
}
