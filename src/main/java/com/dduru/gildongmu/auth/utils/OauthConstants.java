...
//
//     현재 ID Token 기반 로그인만 사용하므로 OAuth 상수들이 사용되지 않음
//
...
//         public static final String SCOPE = "openid email profile";  // 기본 스코프만 사용
...
//         public static final String SCOPE = "openid,profile_nickname,profile_image,account_email";  // 기본 정보만
//
//        private Kakao() {}
//    }
//
