...
class AgeCalculatorTest {
    ...
    void calculateAge() {
        ...
        assertThat(AgeCalculator.calculate(LocalDate.of(2000, 7, 4), today)).isEqualTo(26);
        assertThat(AgeCalculator.calculate(LocalDate.of(2000, 7, 5), today)).isEqualTo(25);
    }

    @Test
    @DisplayName("생년월일이 없으면 null을 반환한다")
    void returnsNullWhenBirthdayMissing() {
        assertThat(AgeCalculator.calculate(null, LocalDate.of(2026, 7, 4))).isNull();
    }
}
